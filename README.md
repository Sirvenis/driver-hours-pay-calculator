...
The free app intentionally shows gross pay estimates only. PAYG tax calculations should be added as paid-version functionality after the PDF tables are converted into tested JSON lookup data.
